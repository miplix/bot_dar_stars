...
1. СНАЧАЛА - краткая суть в 1-3 слова (БЕЗ форматирования, просто текст)
Например: "Хранитель Света" или "Духовный проводник"

2. Затем раздели описание на разделы (каждый раздел должен быть ДЕТАЛЬНЫМ, минимум 3-5 предложений):

*ОДА - Основа личности* 🎁
Код [код дара]
[ДЕТАЛЬНЫЙ анализ главного дара, его значения, как он проявляется в жизни, что означает каждая цифра Ма-Жи-Кун, как они взаимодействуют. Минимум 5-7 предложений. Опирайся на описание из базы, но расширяй и интерпретируй.]

*ТУНА - Временной аспект* 🌙
Код [код дара]. Дар [название дара].
[ДЕТАЛЬНЫЙ анализ как время рождения влияет на характер, что добавляет этот аспект к основному дару, как проявляется в жизни. Минимум 4-6 предложений.]

*ТРИА - Энергия места* 🌍
Код [код дара]
[ДЕТАЛЬНЫЙ анализ влияния места рождения, как географическая точка влияет на судьбу, что дает энергия места. Минимум 4-6 предложений.]

*ЧИА - Имя и судьба* 💫
Код [код дара]. Дар [название дара].
[ДЕТАЛЬНЫЙ анализ влияния имени, как звучание имени влияет на личность, что означает каждая буква, как имя дополняет общую картину. Минимум 4-6 предложений.]

*Общая картина* 🔮
[ДЕТАЛЬНЫЙ синтез всех аспектов - как все 4 компонента взаимодействуют между собой, создавая единую картину личности. Объясни взаимосвязи, как они усиливают или дополняют друг друга. Минимум 5-7 предложений.]
...
• Будь ГЛУБОКИМ и ДЕТАЛЬНЫМ - не ограничивайся кратким описанием
• Опирайся на описания из базы данных, но РАСШИРЯЙ и ИНТЕРПРЕТИРУЙ их
• Объясняй значение каждой цифры Ма-Жи-Кун
...
1. СНАЧАЛА дай краткую суть в 1-3 слова (БЕЗ форматирования)
2. Для каждого компонента (ОДА, ТУНА, ТРИА, ЧИА) дай ДЕТАЛЬНЫЙ анализ:
   - Что означает каждая цифра (Ма, Жи, Кун)
   - Как они взаимодействуют между собой
   - Как это проявляется в жизни человека
   - Как компонент влияет на общую картину
   - Минимум 4-6 предложений для каждого компонента
...
Будь ГЛУБОКИМ, ДЕТАЛЬНЫМ и ПРАКТИЧНЫМ. Не ограничивайся кратким описанием!"""
