...
```bash
python scripts/setup_webhook.py https://your-app.vercel.app/api/webhook
```
...
2. Убедитесь, что webhook установлен правильно: `python scripts/setup_webhook.py info`
...
├── scripts/setup_webhook.py         # Скрипт для установки webhook
